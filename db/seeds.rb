...
# Type d'opération / stade de développement ciblé
InvestorNomenclature.create(type_nomenclature: 'type_operation', name: 'Capital Amorçage')
InvestorNomenclature.create(type_nomenclature: 'type_operation', name: 'Capital Développement')
InvestorNomenclature.create(type_nomenclature: 'type_operation', name: 'Capital Transmission')
InvestorNomenclature.create(type_nomenclature: 'type_operation', name: 'Rachat de positions intermédiaires')
InvestorNomenclature.create(type_nomenclature: 'type_operation', name: 'Retournement')


# Natures opérations
InvestorNomenclature.create(type_nomenclature: 'nature_operation', name: 'Accompagnement')
InvestorNomenclature.create(type_nomenclature: 'nature_operation', name: 'Avance remboursable')
InvestorNomenclature.create(type_nomenclature: 'nature_operation', name: 'Capital - Participation majoritaire')
InvestorNomenclature.create(type_nomenclature: 'nature_operation', name: 'Capital - Participation minoritaire')
InvestorNomenclature.create(type_nomenclature: 'nature_operation', name: 'Capital - Participation majo. et mino.')
InvestorNomenclature.create(type_nomenclature: 'nature_operation', name: 'Cofinancement')
InvestorNomenclature.create(type_nomenclature: 'nature_operation', name: 'Dette')
InvestorNomenclature.create(type_nomenclature: 'nature_operation', name: 'Dette LBO')
InvestorNomenclature.create(type_nomenclature: 'nature_operation', name: 'Dette mezzanine')
InvestorNomenclature.create(type_nomenclature: 'nature_operation', name: 'Quasi-capital')
InvestorNomenclature.create(type_nomenclature: 'nature_operation', name: 'Garantie')
InvestorNomenclature.create(type_nomenclature: 'nature_operation', name: 'Prêt dhonneur')
InvestorNomenclature.create(type_nomenclature: 'nature_operation', name: 'Prêt participatif')
InvestorNomenclature.create(type_nomenclature: 'nature_operation', name: 'Restructuration financière')
InvestorNomenclature.create(type_nomenclature: 'nature_operation', name: 'Subvention')

# Subvention, Prêt d'honneur, Avance remboursable, Prêt participatif, Garantie, Cofinancement, Accompagnement, restructuration financière
