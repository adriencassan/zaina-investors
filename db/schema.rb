...
ActiveRecord::Schema.define(version: 20180617081200) do
  ...
  create_table "companies", force: :cascade do |t|
    ...
    t.string "client_nature"
    t.string "top_clients_weight"
    t.integer "number_employee"
    t.string "top_team"
    t.string "revenues_nature"
    t.string "gross_margin"
    t.string "ebitda"
    t.string "competitive_advantage"
    t.string "risk"
    t.string "business_model"
    t.string "development_plan"
    t.string "document"
    t.bigint "project_id"
  ...
  create_table "projects", force: :cascade do |t|
    ...
    t.boolean "call_done"
    t.boolean "process_zainavalidation"
